...
ax1.plot(z[1:-1], opt.T_MAP, 'blue', label='MAP')
...
ax2.plot(z[1:-1], opt.beta_MAP, 'blue', label='MAP')
...
ax3.semilogy(z[1:-1], opt.std, 'blue', label='MAP')
...
f.tight_layout()
f.savefig("../results/fig2_const(C_m=matrix)_rep")
f.show()
